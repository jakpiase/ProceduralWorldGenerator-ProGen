...
std::unique_ptr<QuestNode> Quests::TerminalExpressions::GoTo::create_node(RegistryUtils& scene) {
...
std::unique_ptr<QuestNode> Quests::TerminalExpressions::Create::create_node(RegistryUtils& scene) {
    const std::string description = std::format("Create {}.", item.get_name());

    return std::make_unique<QuestNode>(description);
}

std::unique_ptr<QuestNode> Quests::TerminalExpressions::Discover::create_node(RegistryUtils& scene) {
...
std::unique_ptr<QuestNode> Quests::TerminalExpressions::Open::create_node(RegistryUtils& scene) {
    const std::string& room_name = scene.get_registry().get<DescriptionComponent>(room).name;
...
std::unique_ptr<QuestNode> Quests::TerminalExpressions::Kill::create_node(RegistryUtils& scene) {
...
std::unique_ptr<QuestNode> Quests::TerminalExpressions::Get::create_node(RegistryUtils& scene) {
...
std::unique_ptr<QuestNode> Quests::TerminalExpressions::Poison::create_node(RegistryUtils& scene) {
...
std::unique_ptr<QuestNode> Quests::TerminalExpressions::Clear::create_node(RegistryUtils& scene) {
    const std::string& target_name = scene.get_name(target);
...
std::unique_ptr<QuestNode> Quests::TerminalExpressions::Find::create_node(RegistryUtils& scene) {
