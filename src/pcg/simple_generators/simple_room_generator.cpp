...
void SimpleRoomGenerator::run(Scene &scene) {
    ...
    top_wall.add_component<PhysicsComponent>(BoundingBox2f(bounding_box.get_top_left(), bounding_box.get_top_right()));
    ...
    right_wall.add_component<PhysicsComponent>(BoundingBox2f(bounding_box.get_top_right(), bounding_box.get_bottom_right()));
    ...
    bottom_wall.add_component<PhysicsComponent>(BoundingBox2f(bounding_box.get_bottom_left(), bounding_box.get_bottom_right()));
    ...
    left_wall.add_component<PhysicsComponent>(BoundingBox2f(bounding_box.get_top_left(), bounding_box.get_bottom_left()));
